...
export default function TestimonialsTemplate2() {
  return (
    <section
      id="testimonials"
      aria-label="What our customers are saying"
      className=" relative bg-transpaarent py-20 sm:py-10 z-1 text-primary-foreground dark:text-primary-90/90"
    >
      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          <h2 className="font-geist text-3xl tracking-tighter sm:text-6xl text-primary">
            <span className="bg-gradient-to-br from-primary-80 via-primary-99 to-primary bg-clip-text text-transparent">
              Loved
            </span>{' '}
            by businesses worldwide.
          </h2>
          <p className="mt-4 text-lg tracking-tight font-geist">
                ...
                {column.map((testimonial, testimonialIndex) => (
                  <li key={testimonialIndex}>
                    <figure className="relative rounded-2xl bg-transparent transform-gpu [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#8686f01f_inset] p-6 shadow-xl ">
                      <QuoteIcon className="absolute left-6 top-6 fill-primary-60/40 opacity-50 z-10" />
                      ...
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-border pt-6">
                        <div>
                          <div className="font-display text-base text-white-shades-90">
                            {testimonial.author.name}
                          </div>
                          <div className="mt-1 text-sm text-grey-40 font-bold">
