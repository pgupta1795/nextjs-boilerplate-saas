...
import { ArrowRightIcon, ChevronRight, MenuIcon, XIcon } from 'lucide-react';
import Image from 'next/image';
import React from 'react';
import SquareGrid from '../background/square-grid';
...
export default function HeroTemplate1() {
  ...
  return (
    <div className="relative w-full flex flex-col">
      <Image
        className="absolute top-0 z-0 -translate-y-1/2 w-full h-full object-cover backdrop-blur-sm shadow-[0_1px_20px_hsl(var(--primary))]"
      ...
      />
      <SquareGrid />
      <nav className="relative items-center pt-5 px-4 mx-auto w-full sm:px-8 md:flex md:space-x-6">
        <div className="flex justify-between">
          ...
          <Button
            size="icon"
            variant="outline"
            className="text-primary outline-none md:hidden"
            onClick={() => setState(!state)}
          >
            {state ? <XIcon /> : <MenuIcon />}
          </Button>
        </div>
        <ul
          className={cn(
            'flex-1 justify-between mt-12 md:text-sm md:font-medium md:flex md:mt-0',
            state
              ? 'fixed inset-x-0 px-4 py-8 border-b bg-background md:border-none md:static bg-opacity-50 backdrop-blur-sm z-50 transition-opacity'
              : 'hidden'
          )}
        >
          ...
          <li className="order-2 py-5 md:py-0">
            <Button
              variant="gooeyLeft"
              className="bg-gradient-to-t from-gray-100 from-0% to-primary"
            >
              Get Started
            </Button>
          </li>
      ...
      <section className="py-28 z-10">
        <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
          <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
            <h1 className="text-sm text-gray-400 group font-geist mr-auto px-5 py-2 bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent border-[2px] border-primary/50 hover:border-primary rounded-3xl w-fit transform delay-150">
              {content.heroSummary}
              <ChevronRight className="inline w-4 h-4 ml-2 group-hover:translate-x-1 duration-300" />
            </h1>
            <h2 className="text-4xl md:text-5xl font-geist font-normal tracking-tighter lg:text-5x  l text-transparent bg-clip-text bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
              {content.heroHeader}
            </h2>
            <p className="font-geist">{content.heroContent}</p>
            <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
              <Button
                className="h-12 bg-gradient-to-t from-primary from-0% to-white transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50"
                variant="gooeyRight"
              >
                {content.signUp}
          ...
          <div className="flex-none mt-14 md:mt-0 md:max-w-xl">
            <Image
              className="md:rounded-tl-[108px] w-auto h-auto"
