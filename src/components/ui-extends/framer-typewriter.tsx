...
/**
 * A Framer motion component that implements a typewriter animation effect, where text is gradually displayed one character at a time.
 *
 * @param {ITypewriterProps} props - The component props.
 * @param {number} props.delay - The delay in seconds before the animation starts.
 * @param {string[]} props.texts - An array of strings to be displayed in the typewriter animation.
 * @param {string} [props.baseText] - An optional base text to be displayed before the typewriter animation starts.
 * @returns {JSX.Element} - A React component that renders the typewriter animation.
 *
 * @example
 * ```tsx
 * <Typewriter texts={["Testing 124","Look at newcult.co","and check gnow.io","Sick af"]} delay={1} baseText="Yo " />
 * ```
 */
