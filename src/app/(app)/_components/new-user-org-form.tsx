...
import { new_user_setup_step_cookie } from '@/lib/config/cookie-keys';
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Enter the email of your organization. This could be your
                    personal email or a shared email.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ali's Org" {...field} />
                  </FormControl>
                  <FormDescription>
          ...
          <CardFooter className='flex items-center justify-end gap-2'>
            {prevBtn ? (
              <Button
                ...
                type='button'
              >
                {isPrevPending ? <Icons.loader className='h-4 w-4' /> : null}
                <span>Previous</span>
              </Button>
            ) : null}
            <Button
              disabled={
                isPending || isMutatePending || isCompleteNewUserPending
              }
              type='submit'
              className='gap-2'
            >
