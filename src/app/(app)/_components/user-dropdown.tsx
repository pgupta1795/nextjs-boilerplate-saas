import SignoutTrigger from '@/components/ui-extends/signout-trigger';
  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button
          variant='outline'
          className={cn('flex w-full justify-start gap-2 overflow-hidden p-2')}
      ...
      <DropdownMenuContent className='w-60' align='start'>
        <DropdownMenuLabel className='flex w-56 flex-col items-start gap-2'>
          ...
          <div className='flex w-full flex-col'>
            <p className='truncate text-sm'>{user?.name ?? 'Name not found'}</p>
