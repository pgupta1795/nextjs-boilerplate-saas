...
const content = {
  dialogTitle: 'Organization Details',
  dialogDescription: 'View the details of the organization.',
...
export function OrgDetails(props: OrganizationsData) {
  return (
    <Dialog>
      ...
      <DialogContent className='max-h-screen overflow-auto'>
        ...
        <div className='grid gap-4'>
          ...
          <div className='flex flex-wrap items-center gap-2'>
            ...
            >
              {props.subscribed
                ? content.subscribedBadge
                : content.unsubscribedBadge}
            </Badge>
          </div>
              ...
              <Avatar className='h-8 w-8'>
                ...
                <AvatarFallback className='text-xs'>
                  {props.owner.name?.charAt(0).toUpperCase() ??
                    props.owner.email.charAt(0).toUpperCase()}
                </AvatarFallback>
              </Avatar>
              <div>
                <p className='w-full truncate text-sm font-medium'>
